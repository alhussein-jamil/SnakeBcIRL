...
def get_dataset_data(dataset_path: str, env_name: str):
    ...
    dataset["actions"] = torch.tensor(dataset["actions"],dtype = torch.float32)
    dataset["rewards"] = torch.tensor(dataset["rewards"],dtype = torch.float32)
